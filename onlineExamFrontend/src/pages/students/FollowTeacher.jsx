...
function FollowTeacher() {
    ...
    const fetchTeachers = async () => {
      try {
        const response = await axios.get(
          "http://localhost:4040/institute/getAll"
        );
  ...
  const handleConnectBar = async (id) => {
    const updatedTeachers = teachers.filter((t) => t.myInstituteId !== id);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 animate-fade-in">
