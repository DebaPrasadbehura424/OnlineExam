...
function ShowPaperQuestion(props) {
  ...
  const currentQuestions = questionPaper?.questions.slice(
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-center">
            {questionPaper.examTitle}
          </h1>
          <p className="text-lg text-center">{questionPaper.subject} Exam</p>
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-center">
            ...
            <div>
              ...
              {questionPaper.examDuration} mins
            </div>
            <div>
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="text-sm font-medium text-gray-700">
            Page {currentPage} of{" "}
            {Math.ceil(questionPaper.questions.length / questionsPerPage)}
          </div>
